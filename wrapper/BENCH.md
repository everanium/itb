...
go test -run='^$' -bench='BenchmarkMessageTriple/facade-nomac' -benchtime=5s -count=1 ./wrapper/
...
Column abbreviations in the Full ITB + wrapper tables: **Facade** = `triple.Pipeline` facade, **LL** = Low-Level (`*Cfg` entry points), **Loop** = User-Driven Loop, **IO** = IO-Driven, **NoMAC** = No MAC, **MAC** = MAC Authenticated, **Enc** / **Dec** = encrypt / decrypt direction. All throughput is MB/s, rounded.
...
| Cipher | Facade NoMAC Enc | Facade NoMAC Dec | Facade MAC Enc | Facade MAC Dec | LL NoMAC Enc | LL NoMAC Dec | LL MAC Enc | LL MAC Dec |
|---|---|---|---|---|---|---|---|---|
...
| Cipher | AEAD Facade IO Enc | AEAD Facade IO Dec | AEAD LL IO Enc | AEAD LL IO Dec |
|---|---|---|---|---|
...
| Cipher | Facade IO Enc | Facade IO Dec | Facade Loop Enc | Facade Loop Dec | LL IO Enc | LL IO Dec | LL Loop Enc | LL Loop Dec |
|---|---|---|---|---|---|---|---|---|
