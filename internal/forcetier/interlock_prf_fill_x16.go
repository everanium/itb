...
// that would otherwise select it. ITB_FORCE_INTERLOCK_PRF_FILL_X4 and
// _X1 disarm the batch-16 rung as well, ITB_FORCE_INTERLOCK_PRF_FILL_SEQ
// every batched rung. Not a production setting. The variable is read on
