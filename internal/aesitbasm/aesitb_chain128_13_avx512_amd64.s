...
TEXT ·aesITB128ChainAbsorb13x4Avx512Asm(SB), NOSPLIT, $0-32
	MOVQ key+0(FP), AX
	MOVQ seeds+8(FP), BX
	...
	VBROADCASTI32X4 ·pad13Tail(SB), Z10
	VPINSRQ $0, 0(R8), X10, X11
	VPINSRD $2, 8(R8), X11, X11
	VPINSRB $12, 12(R8), X11, X11
	VPINSRQ $0, 0(R9), X10, X12
	VPINSRD $2, 8(R9), X12, X12
	VPINSRB $12, 12(R9), X12, X12
	VPINSRQ $0, 0(R10), X10, X13
	VPINSRD $2, 8(R10), X13, X13
	VPINSRB $12, 12(R10), X13, X13
	VPINSRQ $0, 0(R11), X10, X14
	VPINSRD $2, 8(R11), X14, X14
	VPINSRB $12, 12(R11), X14, X14
