...
// 36-byte shape, 8 lanes (3 PKCS#7 blocks, 5 AES rounds per
// cascade round).
...
TEXT ·aesITB128FusedChain36x8Avx512Asm(SB), NOSPLIT, $0-40
	MOVQ key+0(FP), AX
	MOVQ comps+8(FP), BX
	...
	// Lanes 0..3: blocks 0..2 into Z15..Z17
	MOVQ 0(DX), R8
	MOVQ 8(DX), R9
	MOVQ 16(DX), R10
	MOVQ 24(DX), R11
	...
	// Lanes 4..7: blocks 0..2 into Z18..Z20
	MOVQ 32(DX), R8
	MOVQ 40(DX), R9
	MOVQ 48(DX), R10
	MOVQ 56(DX), R11
	...
	VINSERTI64X2 $1, 16(R9), Z19, Z19
	VINSERTI64X2 $2, 16(R10), Z19, Z19
	VINSERTI64X2 $3, 16(R11), Z19, Z19
	VPINSRD $0, 32(R8), X13, X4
...
loop:
	...
	VPXORD Z13, Z14, Z14
	VPTERNLOGQ $0x96, Z14, Z15, Z0; VPTERNLOGQ $0x96, Z14, Z18, Z1
	VAESENC Z2, Z0, Z0; VAESENC Z2, Z1, Z1
	VPXORD Z16, Z0, Z0; VPXORD Z19, Z1, Z1
