...
TEXT ·aesITB128ChainAbsorb68x4Avx512Asm(SB), NOSPLIT, $0-32
	MOVQ key+0(FP), AX
	MOVQ seeds+8(FP), BX
	...
	VMOVDQU 32(R8), X11
	VINSERTI64X2 $1, 32(R9), Z11, Z11
	VINSERTI64X2 $2, 32(R10), Z11, Z11
	VINSERTI64X2 $3, 32(R11), Z11, Z11
	VPXORD Z11, Z0, Z0
	VAESENC Z4, Z0, Z0

	VMOVDQU 48(R8), X11
	VINSERTI64X2 $1, 48(R9), Z11, Z11
	VINSERTI64X2 $2, 48(R10), Z11, Z11
	VINSERTI64X2 $3, 48(R11), Z11, Z11
	VPXORD Z11, Z0, Z0
	VAESENC Z5, Z0, Z0

	VPINSRD $0, 64(R8), X10, X11
	VPINSRD $0, 64(R9), X10, X12
	VPINSRD $0, 64(R10), X10, X13
	VPINSRD $0, 64(R11), X10, X14
	VINSERTI64X2 $1, X12, Z11, Z11
	VINSERTI64X2 $2, X13, Z11, Z11
	VINSERTI64X2 $3, X14, Z11, Z11
	VPXORD Z11, Z0, Z0
