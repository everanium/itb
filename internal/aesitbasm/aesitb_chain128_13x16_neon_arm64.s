...
TEXT ·aesITB128ChainAbsorb13x16NeonAsm(SB), NOSPLIT, $0-40
	...
	// Step 2 — round 1 on all 16 lanes: AESE folds key ^ seeds
	...
	// Step 3 — round 2 on all 16 lanes (RC[0] in V31).
	AESE V31.B16, V0.B16
	AESMC V0.B16, V0.B16
	AESE V31.B16, V1.B16
	AESMC V1.B16, V1.B16
	...
	// Step 4 — round 3 on all 16 lanes (RC[0] in V31).
	AESE V31.B16, V0.B16
	AESMC V0.B16, V0.B16
	AESE V31.B16, V1.B16
	AESMC V1.B16, V1.B16
	...
	// Step 5 — final AddRoundKey with RC[1] (V29) on all 16 lanes.
	...
	// Step 6 — store the 16 rank pairs in lane order.
	VST1.P [V0.B16], 16(R4)
	VST1.P [V1.B16], 16(R4)
	VST1.P [V2.B16], 16(R4)
	VST1.P [V3.B16], 16(R4)
