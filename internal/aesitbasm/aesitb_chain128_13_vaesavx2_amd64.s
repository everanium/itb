...
TEXT ·aesITB128ChainAbsorb13x4VaesAvx2Asm(SB), NOSPLIT, $0-32
	MOVQ key+0(FP), AX
	MOVQ seeds+8(FP), BX
	...
	VBROADCASTI128 ·pad13Tail(SB), Y11
	VPINSRQ $0, 0(R8), X11, X12
	VPINSRD $2, 8(R8), X12, X12
	VPINSRB $12, 12(R8), X12, X12
	VPINSRQ $0, 0(R9), X11, X14
	VPINSRD $2, 8(R9), X14, X14
	VPINSRB $12, 12(R9), X14, X14
	VINSERTI128 $1, X14, Y12, Y12
	VPXOR Y12, Y0, Y0
	VPINSRQ $0, 0(R10), X11, X13
	VPINSRD $2, 8(R10), X13, X13
	VPINSRB $12, 12(R10), X13, X13
	VPINSRQ $0, 0(R11), X11, X15
	VPINSRD $2, 8(R11), X15, X15
	VPINSRB $12, 12(R11), X15, X15
