...
TEXT ·sipHash24Chain128Absorb20x4Avx2Asm(SB), NOSPLIT, $0-24
	MOVQ seeds+0(FP),    BX
	...
	// ===== final padded block: data[16:20] | (20<<56) =====
	MOVL 16(R8),  R12; VMOVQ R12, X4
	MOVL 16(R9),  R12; VPINSRQ $1, R12, X4, X4
	MOVL 16(R10), R12; VMOVQ R12, X6
	MOVL 16(R11), R12; VPINSRQ $1, R12, X6, X6
	VINSERTI128 $1, X6, Y4, Y4
	MOVQ $0x1400000000000000, R12; VMOVQ R12, X6; VPBROADCASTQ X6, Y6; VPXOR Y6, Y4, Y4
	SIP_ABSORB
