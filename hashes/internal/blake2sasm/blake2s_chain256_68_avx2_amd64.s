...
// shape). AVX2 counterpart of blake2s_chain256_68_amd64.s. Two 64-byte
...
TEXT ·blake2s256ChainAbsorb68x4Avx2Asm(SB), NOSPLIT, $288-40
	MOVQ h0+0(FP),        AX
	MOVQ b2key+8(FP),     BX
	MOVQ seeds+16(FP),    CX
	...
	// Block 2: t_lo=100, f=^0. v15=IV[7] → slot.
	MOVL $100, R12
	VMOVD R12, X15
	VPBROADCASTD X15, X15
	VPXOR X15, X12, X12
	...
	// Block 2 messages: m0..8 = data[32:68] (9 dwords), m9..15 = 0.
	DATA_D(32, M(0))
	DATA_D(36, M(1))
	DATA_D(40, M(2))
	DATA_D(44, M(3))
