...
// chacha20asm_entropy_test.go — the input-entropy differential audit
...
// cascade (ScalarFusedChain256 and the scalar fill reference) at the
// baseline and after every flip. The helpers drive the single-, four-
// and eight-lane evaluators and the fill hook through the audit; the
