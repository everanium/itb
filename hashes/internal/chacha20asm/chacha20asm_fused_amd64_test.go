...
var kernels256x4 = map[string]map[int]x4fn256{
	"avx512": {13: wrap4_256(chacha20FusedChain13x4Avx512Asm), 20: wrap4_256(chacha20FusedChain20x4Avx512Asm), 36: wrap4_256(chacha20FusedChain36x4Avx512Asm), 68: wrap4_256(chacha20FusedChain68x4Avx512Asm)},
	"avx2":   {13: wrap4_256(chacha20FusedChain13x4Avx2Asm), 20: wrap4_256(chacha20FusedChain20x4Avx2Asm), 36: wrap4_256(chacha20FusedChain36x4Avx2Asm), 68: wrap4_256(chacha20FusedChain68x4Avx2Asm)},
}
...
func TestFusedDispatcherTiersAmd64(t *testing.T) {
	...
	t.Run("gpr", func(t *testing.T) {
		setCascadeTier(cascadeTier{name: "gpr", ok: true, gpr: true})
