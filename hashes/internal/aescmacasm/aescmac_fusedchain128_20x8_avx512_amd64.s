...
// 20-byte shape, 8 lanes (2 zero-padded blocks, 2 AES-128
...
TEXT ·aesCMAC128FusedChain20x8Avx512Asm(SB), NOSPLIT, $0-40
	...
	VPXORD Z14, Z15, Z15
	// Lanes 0..3: blocks 0..1 into Z16..Z17
	MOVQ 0(DX), R8
	MOVQ 8(DX), R9
	MOVQ 16(DX), R10
	MOVQ 24(DX), R11
	...
	VPXORD Z15, Z16, Z16
	VPXORD Z14, Z17, Z17
	// Lanes 4..7: blocks 0..1 into Z18..Z19
	MOVQ 32(DX), R8
	MOVQ 40(DX), R9
	MOVQ 48(DX), R10
	MOVQ 56(DX), R11
...
loop:
	...
	VPTERNLOGQ $0x96, Z12, Z16, Z0; VPTERNLOGQ $0x96, Z12, Z18, Z1
	...
	VPXORD Z17, Z0, Z0; VPXORD Z19, Z1, Z1
	VAESENC Z2, Z0, Z0; VAESENC Z2, Z1, Z1
	VAESENC Z3, Z0, Z0; VAESENC Z3, Z1, Z1
	VAESENC Z4, Z0, Z0; VAESENC Z4, Z1, Z1
	VAESENC Z5, Z0, Z0; VAESENC Z5, Z1, Z1
