...
// Fused-cascade tier flags of the BLAKE3 kernels. At most one flag of
...
func Fused256Chain13x4(fixedKey *[32]byte, components []uint64, dataPtrs *[4]*byte, out *[4][4]uint64) {
	...
	switch {
	case FusedHasAVX512:
		blake3FusedChain13x4Avx512Asm(fixedKey, c, ng, dataPtrs, out)
	case FusedHasAVX2:
...
func Fused256Chain20x4(fixedKey *[32]byte, components []uint64, dataPtrs *[4]*byte, out *[4][4]uint64) {
	...
	switch {
	case FusedHasAVX512:
		blake3FusedChain20x4Avx512Asm(fixedKey, c, ng, dataPtrs, out)
	case FusedHasAVX2:
...
func Fused256Chain36x4(fixedKey *[32]byte, components []uint64, dataPtrs *[4]*byte, out *[4][4]uint64) {
	...
	switch {
	case FusedHasAVX512:
		blake3FusedChain36x4Avx512Asm(fixedKey, c, ng, dataPtrs, out)
	case FusedHasAVX2:
...
func Fused256Chain68x4(fixedKey *[32]byte, components []uint64, dataPtrs *[4]*byte, out *[4][4]uint64) {
	...
	switch {
	case FusedHasAVX512:
		blake3FusedChain68x4Avx512Asm(fixedKey, c, ng, dataPtrs, out)
	case FusedHasAVX2:
...
func Fused256Fill13x8(fixedKey *[32]byte, components []uint64, groupIdxBase uint64, out *[8][4]uint64) {
	...
	switch {
	case HasAVX512X16:
		blake3FusedChain13x8Avx512Asm(fixedKey, c, ng, groupIdxBase, out)
	case HasAVX2X16:
...
func Fused256Chain20x8(fixedKey *[32]byte, components []uint64, dataPtrs *[8]*byte, out *[8][4]uint64) {
	if FusedX8Active() && validComponents256(components) {
		blake3FusedChain20x8Avx512Asm(fixedKey, &components[0], len(components)/4, dataPtrs, out)
		return
	}
...
func Fused256Chain36x8(fixedKey *[32]byte, components []uint64, dataPtrs *[8]*byte, out *[8][4]uint64) {
	if FusedX8Active() && validComponents256(components) {
		blake3FusedChain36x8Avx512Asm(fixedKey, &components[0], len(components)/4, dataPtrs, out)
		return
	}
...
func Fused256Chain68x8(fixedKey *[32]byte, components []uint64, dataPtrs *[8]*byte, out *[8][4]uint64) {
	if FusedX8Active() && validComponents256(components) {
		blake3FusedChain68x8Avx512Asm(fixedKey, &components[0], len(components)/4, dataPtrs, out)
		return
	}
...
// Kernels (blake3_fusedchain256_<shape>x4_<tier>_amd64.s, the eight-lane
// per-pixel and fill kernels blake3_fusedchain256_<shape>x8_avx512_amd64.s
// and the single-lane kernels blake3_fusedchain256_<shape>x1_gpr_amd64.s).
//
//go:noescape
func blake3FusedChain13x4Avx512Asm(fixedKey *[32]byte, comps *uint64, nGroups int, dataPtrs *[4]*byte, out *[4][4]uint64)
...
//
//go:noescape
func blake3FusedChain20x4Avx2Asm(fixedKey *[32]byte, comps *uint64, nGroups int, dataPtrs *[4]*byte, out *[4][4]uint64)

//
//go:noescape
func blake3FusedChain36x4Avx512Asm(fixedKey *[32]byte, comps *uint64, nGroups int, dataPtrs *[4]*byte, out *[4][4]uint64)

//
//go:noescape
func blake3FusedChain36x4Avx2Asm(fixedKey *[32]byte, comps *uint64, nGroups int, dataPtrs *[4]*byte, out *[4][4]uint64)
...
//
//go:noescape
func blake3FusedChain13x8Avx512Asm(fixedKey *[32]byte, comps *uint64, nGroups int, groupIdxBase uint64, out *[8][4]uint64)
...
//
//go:noescape
func blake3FusedChain36x8Avx512Asm(fixedKey *[32]byte, comps *uint64, nGroups int, dataPtrs *[8]*byte, out *[8][4]uint64)
...
//
//go:noescape
func blake3FusedChain20x1GprAsm(fixedKey *[32]byte, comps *uint64, nGroups int, data *byte, out *[4]uint64)

//
//go:noescape
func blake3FusedChain36x1GprAsm(fixedKey *[32]byte, comps *uint64, nGroups int, data *byte, out *[4]uint64)
