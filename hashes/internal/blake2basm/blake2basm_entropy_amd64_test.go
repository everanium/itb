...
// blake2basm_entropy_amd64_test.go — the input-entropy differential
...
// the four-lane kernels of both tiers at both widths, the single-lane
// GPR kernels, the eight-lane ZMM kernels and the eight-lane ZMM fill
