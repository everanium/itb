...
// YMM-batched fused chain-absorb kernel for BLAKE2b-512 with 20-byte
// per-lane data input (the ITB SetNonceBits(128) buf shape — default
// config). Four pixels processed lane-parallel: the 4 × 64-bit lane
// qwords fill one YMM register exactly, so 16 YMM registers hold the
// four lane-isolated BLAKE2b states v[0..15] across all 12 mixing
// rounds. The remaining 16 YMMs hold m[0..15] across the four lanes
