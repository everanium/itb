...
var kernels256x4 = map[string]map[int]x4fn256{
	"avx512": {13: wrap4_256(blake2b256FusedChain13x4Avx512Asm), 20: wrap4_256(blake2b256FusedChain20x4Avx512Asm), 36: wrap4_256(blake2b256FusedChain36x4Avx512Asm), 68: wrap4_256(blake2b256FusedChain68x4Avx512Asm)},
	"avx2":   {13: wrap4_256(blake2b256FusedChain13x4Avx2Asm), 20: wrap4_256(blake2b256FusedChain20x4Avx2Asm), 36: wrap4_256(blake2b256FusedChain36x4Avx2Asm), 68: wrap4_256(blake2b256FusedChain68x4Avx2Asm)},
}

var kernels512x4 = map[string]map[int]x4fn512{
	"avx512": {13: wrap4_512(blake2b512FusedChain13x4Avx512Asm), 20: wrap4_512(blake2b512FusedChain20x4Avx512Asm), 36: wrap4_512(blake2b512FusedChain36x4Avx512Asm), 68: wrap4_512(blake2b512FusedChain68x4Avx512Asm)},
	"avx2":   {13: wrap4_512(blake2b512FusedChain13x4Avx2Asm), 20: wrap4_512(blake2b512FusedChain20x4Avx2Asm), 36: wrap4_512(blake2b512FusedChain36x4Avx2Asm), 68: wrap4_512(blake2b512FusedChain68x4Avx2Asm)},
}
			...
			if tier.avx512 {
				t.Run("fill256x8", func(t *testing.T) {
					checkFill256(t, "avx512-x8", func(k *[32]byte, c []uint64, base uint64, o *[8][4]uint64) {
						blake2b256FusedChain13x8Avx512Asm(k, &c[0], len(c)/4, base, o)
					})
				})
			}
		})
