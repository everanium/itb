...
// Forcing both nonces realises the full Nonce-Reuse lab assumption
// (simultaneous collision of the main nonce and the interlock nonce —
// the worst case the reuse threat model targets); a production caller
