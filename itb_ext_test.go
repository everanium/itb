...
// this file carries the helper functions (seed builders, primitive
// Pair factories, lockSeed-slot fixtures) plus the cross-constructor
// agreement coverage below, and the Triple Ouroboros benchmarks +
// integration tests live in itb3_ext_test.go.
package itb_test
...
// --- Cross-constructor agreement of Low-Level seeds -------------------------
//
// Coverage at every width and for every shipped primitive. The
