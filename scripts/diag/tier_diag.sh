...
COMMON_ENV="ITB_INNER_HASH=areion512 ITB_KEY_BITS=512 ITB_NONCE_BITS=512 ITB_WITH_MAC=false ITB_WITH_PARALLAX=false ITB_WITH_WRAPPER=false ITB_GOMEMLIMIT=4GiB ITB_GOGC=100"
