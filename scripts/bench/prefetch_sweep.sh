...
#
# Usage:
#   $TOOLS/prefetch_sweep.sh
#
# Env overrides:
#   ITB_REPO                 (default $HOME/go/src/itb)
...
echo "  scp -r $TOOLS/prefetch_sweep.sh <target-host>:$TOOLS/"
echo "  ssh <target-host> 'ITB_REPO=/path/to/itb $TOOLS/prefetch_sweep.sh'"
