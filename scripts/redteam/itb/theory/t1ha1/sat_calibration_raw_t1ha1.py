...
# -*- coding: utf-8 -*-
"""
Calibration: raw t1ha1 ChainHash lo-lane SAT inversion cost.
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        default=str(Path(os.environ.get(
            "SAT_CALIBRATION_RAW_T1HA1_OUTPUT_DIR",
            str(Path.home() / "scratch" / "redteam" / "t1ha1stress"),
