...
# shelf primitives. The chainhashes/seahash.py Python mirror is parity-
...
#   HARNESS_BIAS_AUDIT_OUTPUT_DIR  default: ${HOME}/scratch/redteam/harness_bias_audit_seahash
...
#   ${OUTPUT_DIR}/<RESULTS_TAG>/probe_seahash_<N>_ascii.log
...
OUTPUT_DIR=${HARNESS_BIAS_AUDIT_OUTPUT_DIR:-"${HOME}/scratch/redteam/harness_bias_audit_seahash"}
...
for size in $SIZES; do
    ...
    # Invoke the raw-mode bias probe; point it at chainhashes.seahash (Python
    # mirror bit-exact-verified against the Go seahash_64le reference by
    # scripts/redteam/itb/theory/_common/chainhashes/_parity_test.py).
