...
# two-lane adapter shelfMx3Hash128 defined in harness_shelf_test.go), then runs the
...
for size in $SIZES; do
    ...
    cell_log="${RESULTS_ROOT}/probe_mx3_${size}_ascii.log"
    ...
    go test -tags redteam -run TestRedTeamHarnessGenerateMx3NonceReuse \
...
row = {
    "primitive": "mx3",
    "hash_display": meta.get("hash_display", "mx3_64le"),
