...
# -*- coding: utf-8 -*-
"""
Calibration: raw mx3 ChainHash lo-lane SAT inversion cost.
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        default=str(Path(os.environ.get(
            "SAT_CALIBRATION_RAW_MX3_OUTPUT_DIR",
            str(Path.home() / "scratch" / "redteam" / "mx3stress"),
