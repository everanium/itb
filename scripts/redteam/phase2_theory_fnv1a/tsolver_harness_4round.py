...
is a the project guidelines attacker-realism violation and MUST be replaced by
...
def main() -> int:
    ...
    # the project guidelines attacker-realism violation; replace with a noise_pos search.
