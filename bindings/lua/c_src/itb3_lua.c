 ...
 * libitb3 writes a JSON array of strings; profile names are restricted
...
/* pipe:max_workers(n) — sets the worker cap; n is clamped by libitb3
...
/* pipe:free() — releases the handle (libitb3 closes and zeroes key
