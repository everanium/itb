 ...
 * long) libitb3 call.
 *
 * Compile-time linked against libitb3 (-litb3) with an RPATH pointing
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_version(
...
JNIEXPORT jlong JNICALL Java_io_github_everanium_itb3_Native_setMemoryLimit(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_setGCPercent(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleLoad(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleLoadF(
    JNIEnv *env, jclass cls, jobject path,
    jobject permMaster, jlong permLen,
    jobject wrapMaster, jlong wrapLen, jlong mastersCount, jlongArray outHandle) {
    (void)cls;
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleSave(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleSaveF(
    JNIEnv *env, jclass cls, jlong handle, jobject path) {
    (void)cls;
    return ITB_Triple_SaveF((uintptr_t)handle, (char *)addr(env, path));
}

JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleInspect(
    JNIEnv *env, jclass cls, jobject blob, jlong blobLen,
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleMaxWorkers(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleRekey(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleClose(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleFree(
    JNIEnv *env, jclass cls, jlong handle) {
    (void)env;
    (void)cls;
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleRegister(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleLookup(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleProfiles(
...
#define CIPHER_SHIM(java_name, itb_name)                                    \
    JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_##java_name(       \
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleEncryptStreamBegin(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleDecryptStreamBegin(
    JNIEnv *env, jclass cls, jlong pipe, jlongArray outStream) {
    (void)cls;
    uintptr_t stream = 0;
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleStreamWrite(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleStreamEnd(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleStreamRead(
...
JNIEXPORT jint JNICALL Java_io_github_everanium_itb3_Native_tripleStreamFree(
    JNIEnv *env, jclass cls, jlong stream) {
    (void)env;
    (void)cls;
