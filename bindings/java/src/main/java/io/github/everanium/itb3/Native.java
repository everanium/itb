// JNI declaration bundle for the libitb3 ITB_Triple_* surface.
//
// Every native method is a direct proxy to one prototype in
// cmd/cshared/libitb3.h. Buffers cross the boundary as direct
...
//
// The shim library (libitb3_jni.so) is resolved at class load:
//
//   1. ITB_JNI_PATH environment variable (absolute path to the shim).
//   2. System.loadLibrary("itb3_jni") over java.library.path.
//
// libitb3.so itself is a link-time dependency of the shim, found via
