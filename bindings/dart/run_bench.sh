...
# Builds libitb.so via build.sh, then runs bench/bench.dart:
...
# bench/bench.dart reads ITB_MSG_PROFILE for the Message shape and
...
exec dart run bench/bench.dart
