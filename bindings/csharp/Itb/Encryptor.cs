        ...
        try
        {
            ...
            while (!eof)
            {
                ...
                if (eof && filled == 0)
                {
                    ...
                    // (Bonus 1 in the design notes) so the streaming
                ...
                var isFinal = probe < 0;
                // Routes through the per-encryptor _outputBuffer cache
                // (Bonus 1 in the design notes) — same scope as the
            ...
            while (true)
            {
                ...
                if (n == 0)
                {
                    ...
                    while (!seenFinal && (accumEnd - accumStart) >= headerSz)
                    {
                        ...
                        // cache (Bonus 1 in the design notes) — same
                ...
                while (true)
                {
                    ...
                    // Routes through the per-encryptor _outputBuffer
                    // cache (Bonus 1 in the design notes) — same scope
