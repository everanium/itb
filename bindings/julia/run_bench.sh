#!/usr/bin/env bash
#
# Micro-benchmark runner for the Julia binding. Builds libitb3.so via
# build.sh, then runs bench/bench.jl: encrypt_message and
# stream-session encrypt throughput at 1 MiB / 16 MiB / 64 MiB.
#
# Usage:
#   ./run_bench.sh
