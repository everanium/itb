(ns io.github.everanium.itb3.clojure.stream
  ...
  envelope, and wire-format decisions stay inside libitb3. Closing a
  ...
  (:import [io.github.everanium.itb3 DecryptStream EncryptStream]
