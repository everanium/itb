...
A long-run stress harness under `bindings/vbnet/loop/` holds one
...
`loop/bin/Release/net*/Everanium.LibItb3.VisualBasic.Loop -h` lists every flag. Concurrency mode: **shared-handle** —
