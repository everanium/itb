...
''' <summary>
''' Raised when libitb3 reports a non-OK status. <see cref="Status"/>
...
Public NotInheritable Class ItbException
    ...
    Friend Sub New(status As Status, inner As Global.Everanium.Itb3.ItbException)
...
''' member of the binding: a C# <c>Everanium.Itb3.ItbException</c> escaping the
...
Friend Module ErrorRelay
    ...
    Friend Function Translate(ex As Global.Everanium.Itb3.ItbException) As ItbException
    ...
    Friend Function Guarded(Of T)(fn As Func(Of T)) As T
        Try
            Return fn()
        Catch ex As Global.Everanium.Itb3.ItbException
            Throw Translate(ex)
        End Try
    End Function
