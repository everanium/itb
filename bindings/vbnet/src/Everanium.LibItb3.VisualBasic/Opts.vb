...
''' <see cref="Global.Everanium.Itb3.Profile"/> type.
''' </summary>
Public NotInheritable Class Opts

    Private ReadOnly _inner As New Global.Everanium.Itb3.Opts()

    ''' <summary>The wrapped C# builder handed to the inner layer's
    ''' entry points.</summary>
    Friend ReadOnly Property Inner As Global.Everanium.Itb3.Opts
        Get
            Return _inner
        End Get
    End Property
