...
Public Class PersistTests
    ...
    <Fact>
    Public Sub InspectCarriesTheRuntimeGlobalsLookupDoesNot()
        ...
        Dim opts As Opts = New Opts().WithNonceBits(256).WithBarrierFill(4)
        Using pipe As Pipeline = Pipeline.Init("streaming-aead-triple-mac-v1", opts)
            Dim prof As Global.Everanium.Itb3.Profile = Pipeline.Inspect(pipe.Save())
        ...
        Dim registry As Global.Everanium.Itb3.Profile = Pipeline.Lookup("streaming-aead-triple-mac-v1")
    ...
    Public Sub RegisterCopyOfShippedProfile()
        Dim copy As Global.Everanium.Itb3.Profile = Pipeline.Lookup("singlemsg-triple-nomac-v1")
        copy.Name = ""
        Pipeline.Register("vbnet-binding-test-copy", copy)
        Dim back As Global.Everanium.Itb3.Profile = Pipeline.Lookup("vbnet-binding-test-copy")
