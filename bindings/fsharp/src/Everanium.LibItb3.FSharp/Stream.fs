...
// envelope, and wire-format decisions stay inside libitb3. Both
...
module Stream =
    ...
    /// the same session. A libitb3 failure surfaces as a raised
            ...
            while not finished do
                ...
                if r.Finished then
                    ...
                    if e.MoveNext() then
                        ...
                        ended <- true
        // After finish, an empty drain blocks inside libitb3 until
