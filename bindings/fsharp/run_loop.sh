#!/usr/bin/env bash
#
# Fleet entry point for the loop stress harness of the F# binding:
...
dotnet build loop/Everanium.LibItb3.FSharp.Loop.fsproj -c Release --nologo -v quiet >/dev/null

ARTIFACT=(loop/bin/Release/net*/Everanium.LibItb3.FSharp.Loop)
