...
// in-process libitb3 proxy; this layer adds null-safety, the sealed
...
import io.github.everanium.itb3.Opts as JOpts
 ...
 * letting `use { }` do it) frees the handle — libitb3 zeroes key
...
class Pipeline internal constructor(internal val impl: JPipeline) : AutoCloseable {
    ...
    // libitb3; the IO dispatcher keeps it off the caller's coroutine
    ...
    /** Releases the handle (libitb3 zeroes key material first). */
