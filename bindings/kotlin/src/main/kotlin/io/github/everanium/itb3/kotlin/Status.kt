...
/**
 * Integer status code returned by every libitb3 entry point, surfaced
 ...
 * the roster (a future libitb3 release) maps to [Unknown] instead of
 * failing.
 */
sealed class Status(val code: Int) {
    ...
    /** A code outside the known roster (future libitb3 release). */
    ...
    companion object {
        /** Maps a raw libitb3 status code to its sealed value. */
