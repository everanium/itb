...
//
// Attacker-realism (the project guidelines discipline): all statistics operate on
...
// (per the project guidelines working-tree layout). Override the parent directory
