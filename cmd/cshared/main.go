...
// GOOS) plus an auto-generated libitb3.h header consumed by every
...
// buffer in two phases (see e.g. bindings/python/itb3/_ffi.py).
//
...
// ITB_GOMEMLIMIT env var set at libitb3 load time.
//
...
// calls override any ITB_GOGC env var set at libitb3 load time.
//
...
// nonce_bytes (main_nonce + width(2) + height(2), i.e. nonce_bytes +
