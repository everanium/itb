...
//
// Field naming matches the design notes design baseline: single-letter
...
// responsibility (see [Pipeline.Close] and the design notes for the
...
// the design notes "Master handling + sanity" — protects callers from
