...
// mode-ambiguity envelope invariants (the design notes item 16
...
// the design notes item 16 item 4), the itb container width/height
...
// path prepends a 32-byte dummy prefix (per the design notes item 16
